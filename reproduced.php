...
var items = new Array();
    ...
    items[1]="<img src='http://oneonlinestop.com/metaboapp/_graphics/ecoli_rep2.jpg' height='800' width='800'>"; 
    items[2]="<img src='http://oneonlinestop.com/metaboapp/_graphics/ecoli_rep3.jpg' height='800' width='800'>"; 
    items[3]="<img src='http://oneonlinestop.com/metaboapp/_graphics/ecoli_rep3.jpg' height='800' width='800'>";
    items[4]="<img src='http://oneonlinestop.com/metaboapp/_graphics/ecoli_rep3.jpg' height='800' width='800'>";
...
function rotater() {
    ...
    if(current == 4){
	alert("Your E. coli has reproduced. Start again?");
	window.location = "http://oostop.com/metaboapp"
    }
}
